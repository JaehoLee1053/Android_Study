            ...
            object : retrofit2.Callback<ArrayList<Post>> {
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        post_recyclereview.adapter = adapter
                        post_recyclereview.layoutManager = LinearLayoutManager(this@OutStagramPostListActivity)
                    }
                }
            }
        )
